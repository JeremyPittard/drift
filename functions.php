...
add_action('wp_enqueue_scripts', function () {
	...
	wp_scripts()->add_data('parcel', 'type', 'module');
});



//include file that has wordpress modifications, removing jquery etc
include get_template_directory() . './wp-mods/mods.php';

//include custom settings/options page
